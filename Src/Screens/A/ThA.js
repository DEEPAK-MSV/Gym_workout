...
const ThA = () => {
  return (
    <View style={{flex:1,flexDirection:'column',height:'100%',width:'100%'}}>
      <Image style={styles.img} source={{uri:'https://www.xzonegym.com/images/product/triceps_0.jpg'}}/>
      <ScrollView style={styles.container}>
      <View style={styles.touchable}>
        <Text style={styles.txt}>Warmup</Text>
      </View>
      <View style={styles.touchable}>
        <Text style={styles.txt}>Barbell Curl</Text>
        <Text style={styles.val}>4 x 25</Text>
      </View>
      <View style={styles.touchable}>
        <Text style={styles.txt}>Dumbell Overhead</Text>
        <Text style={styles.val}>4 x 25</Text>
      </View>
      <View style={styles.touchable}>
        <Text style={styles.txt}>Dumbell Hammer</Text>
        <Text style={styles.val}>4 x 25</Text>
      </View>
      <View style={styles.touchable}>
        <Text style={styles.txt}>Triceps PushDown</Text>
        <Text style={styles.val}>4 x 25</Text>
      </View>
      <View style={styles.touchable}>
        <Text style={styles.txt}>Dumbell Curl</Text>
        <Text style={styles.val}>4 x 25</Text>
      </View>
      <View style={styles.touchable}>
