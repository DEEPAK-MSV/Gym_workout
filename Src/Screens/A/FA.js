...
const FA = () => {
  return (
    <View style={{flex:1,flexDirection:'column',height:'100%',width:'100%'}}>
      ...
      <View style={styles.touchable}>
        <Text style={styles.txt}>Hanging Leg Raise</Text>
        <Text style={styles.val}>3 x 15</Text>
      </View>
      <View style={styles.touchable}>
      ...
      <View style={styles.touchable}>
        <Text style={styles.txt}>Russian Twist</Text>
        <Text style={styles.val}>4 x 25</Text>
      </View>
      <View style={styles.touchable}>
        <Text style={styles.txt}>Leg Raises</Text>
        <Text style={styles.val}>3 x 25</Text>
      </View>
      <View style={styles.touchable}>
        <Text style={styles.txt}>Plank</Text>
        <Text style={styles.val}>5 Mins x 2</Text>
      </View>
      <View style={styles.touchable}>
