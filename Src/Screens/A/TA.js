...
const TA = () => {
  return (
    <View style={{flex:1,flexDirection:'column',height:'100%',width:'100%'}}>
      <Image style={styles.img} source={{uri:'https://www.xzonegym.com/images/product/shoulders_0.jpg'}}/>
      <ScrollView style={styles.container}>
      <View style={styles.touchable}>
        <Text style={styles.txt}>Warmup</Text>
      </View>
      <View style={styles.touchable}>
        <Text style={styles.txt}>Dumbell Front Raise</Text>
        <Text style={styles.val}>4 x 25</Text>
      </View>
      <View style={styles.touchable}>
        <Text style={styles.txt}>Dumbell Side Raise</Text>
        <Text style={styles.val}>4 x 25</Text>
      </View>
      <View style={styles.touchable}>
        <Text style={styles.txt}>Barbell Front Raise</Text>
        <Text style={styles.val}>4 x 25</Text>
      </View>
      <View style={styles.touchable}>
        <Text style={styles.txt}>Barbell Back Raise</Text>
        <Text style={styles.val}>4 x 25</Text>
      </View>
      <View style={styles.touchable}>
        <Text style={styles.txt}>Dumbell Raise</Text>
        <Text style={styles.val}>4 x 25</Text>
      </View>
      <View style={styles.touchable}>
